...
date:  "March 2021 | [slides](https://bitss.github.io/UMass20201/)"
output: 
  xaringan::moon_reader:
    footer: "These slides available at https://bitss.github.io/UMass20201/"
...
Christensen, Freese and Miguel (2020) suggest detailed information on:

.pull-left[
1 - Detail study design  
2 - Sampling details  
3 - Outcome Measures  
4 - Index construction  
5 - Multiple hypothesis adjustments  
6 - Subgroup analysis  
]

.pull-right[
7 - Direction of the effect (optional)  
8 - Exact statistical specification  
9 - Structural model (optional)  
10 - Timestamp  
]
...
## Additional Motivation: More Inclusive Concept Scholarly Output
